...
/* cofactor.c */ extern int binate_split_select (pset *T, pset cleft, pset cright, int debug_flag);
...
/* contain.c */ extern int rm2_equal (pset *A1, pset *B1, pset *E1, qsort_compare_func compare); 
...
/* essen.c */ extern pset_family cb_consensus_dist0 (pset_family R, pset p, pset c);
...
/* expand.c */ extern pset_family find_all_primes (pset_family BB, pset RAISE, pset FREESET);
...
/* expand.c */ extern void essen_raising (pset_family BB, pset RAISE, pset FREESET);
...
/* opo.c */ extern pset_family opo_leaf (pset_family T, pset select, int out1, int out2);
...
/*readfile.c*/ extern void getPLA(int argc, char** argv, pPLA* PLA);
